...
* 互惠性：商家给予**何种群体****何种利益**使产生亏欠感后通过**何种方式**回馈商家
* 稀缺性：**限时**/**限量**，使**何种群体**产生紧迫感
* 共识性：**何种群体**因**何种原因**对**何种人/事/物**有**何种共识**，有**何种影响**
* 权威性：**何种群体**因**何种原因**对**何种人/事/物**产生信任，有**何种影响**
* 一致性：商家通过**何种方式**使**何种群体**作下**何种承诺**，这种承诺将导致**何种影响**
* 偏好性：商家通过**何种方式**贴近**何种偏好性群体**
...
### 3. 文字表达能力
* 准确：清晰地表达自己的观点和理解，不模棱两可，尽量不使用“可能”“或许”“我认为”这种词汇
* 简洁：在不影响准确性的前提下用最少的字数表达，能删掉的字句就不要保留
* 文字风格：准确简洁的前提下鼓励学员有自己的文字风格，文字风格是个人魅力展现的重要方式

## 四、学习态度

### 1. 文字排版
* 页面布局：用分级标题、隔行等操作使文章形成板块，便于阅读
* 字体设置：字体颜色、字号的不同和加粗、等操作使文章层次分明、重点突出
